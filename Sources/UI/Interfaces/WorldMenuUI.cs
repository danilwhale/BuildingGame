...
public class WorldMenuUI : UIInterface
{
    ...
    public override void Initialize()
    {
        ...
        _worldList.OnItemSelect += item =>
        {
            ...
            _selectedWorldPlayTime.Text =
                string.Format(translation.GetTranslatedName("play_time_format"), world.Info.PlayTime);
        };
        ...
        _playWorldButton.OnClick += () => { ScreenManager.Switch(new GameScreen(_paths[_worldList.SelectedItem])); };
        ...
        _createWorldButton.OnClick += () => { ScreenManager.Switch(new CreateWorldScreen()); };
    ...
    public override void Configure()
    {
        ...
        _sidePanel.Size = (new Vector2(GetScreenWidth(), GetScreenHeight()) - _worldList.Size) with
        {
            Y = GetScreenHeight() - _bottomPanel.Size.Y
        };
        ...
        _menuButton.LocalPosition = new Vector2(_bottomPanel.Size.X - _menuButton.Size.X - 32.0f,
            _bottomPanel.Size.Y / 2 - _menuButton.Size.Y / 2);

        _createWorldButton.LocalPosition = new Vector2(8.0f, _bottomPanel.Size.Y / 2 - _createWorldButton.Size.Y / 2);
        _deleteWorldButton.LocalPosition = _createWorldButton.LocalPosition + _createWorldButton.Size with { Y = 0 } +
